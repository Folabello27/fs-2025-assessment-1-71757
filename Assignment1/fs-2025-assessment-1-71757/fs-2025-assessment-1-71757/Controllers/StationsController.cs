...
namespace fs_2025_assessment_1_71757.Controllers
{
    ...
    public class StationsController : ControllerBase
    {
            ...
            [FromQuery] int pageSize = 10)
        {
            ...
            if (!_cache.TryGetValue(cacheKey, out IEnumerable<StationDto>? stations))
            {
                stations = await _bikeService.GetStationsAsync(status, minBikes, q, sort, dir, page, pageSize);

...
public class StationsApiClient
{
        ...
        int pageSize = 10)
    {
        try
        {
            ...
            var url = $"api/v1/stations?{queryString}";
    ...
    public async Task<StationDto?> GetStationAsync(int number)
    {
        try
        {
            var url = $"api/v1/stations/{number}?api-version=1.0";
    ...
    public async Task<StationDto?> CreateStationAsync(CreateStationDto createDto)
    {
        try
        {
            ...
            var response = await _httpClient.PostAsJsonAsync("api/v1/stations?api-version=1.0", createDto, _jsonOptions);
    ...
    public async Task<StationDto?> UpdateStationAsync(int number, UpdateStationDto updateDto)
    {
        try
        {
            ...
            var response = await _httpClient.PutAsJsonAsync($"api/v1/stations/{number}?api-version=1.0", updateDto, _jsonOptions);
    ...
    public async Task<bool> DeleteStationAsync(int number)
    {
        try
        {
            ...
            var response = await _httpClient.DeleteAsync($"api/v1/stations/{number}?api-version=1.0");
